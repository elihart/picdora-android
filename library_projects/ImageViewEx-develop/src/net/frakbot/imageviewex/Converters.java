...
public abstract class Converters {
	 ...
	 * @param opts
	 *            The decoding options to use, or null if you'd like to use
	...
	/**
	 * Determine what scale size should be used to fit the src dimensions into
	 * the destination
	 * 
	 * @param srcWidth
	 * @param srcHeight
	 ...
	 * @param size
	 *            The size of the {@link InputStream}.
	 * 
